pipeline {
    ...
    stages {
		...
		when {
            ...
            steps {
		    checkout scm: [$class: 'GitSCM', source: 'ssh://git@github.com/ATolkachev/epam-ci-cd-app.git', userRemoteConfigs: [[credentialsId: 'atolkachev']], branches: [[name: "${env.branch}"]]], poll: false
